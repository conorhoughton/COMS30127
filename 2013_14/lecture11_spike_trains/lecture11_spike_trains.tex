...
\pagestyle{headings}
\markright{Computational Neuroscience - Lecture 11}
\begin{document}
...
slides that go with this lecture containing pictures. I offer an
...
are moving. If the monkey gets its detemination correct it gets a treat, probably
juice. The experimenter can control the coherence of the dots, at one
extreme there is no movement one way or another, all the dots move
randomly; at the other extreme all the dots are moving the same
way. 

Britten et al. (Neuroscience (1992) 12:4745-65) managed to record from
...
\end{equation}
Now, they don't have the same variances
\begin{equation}
