...
\pagestyle{headings}
\markright{Computational Neuroscience - Lecture 13 / 14}
\begin{document}
...
CA3, along with a \lq{}$k$-winner takes all\rq{} mechanism, which
hasn't been discussed, causes activity in CA3.
\begin{center}
\begin{tikzpicture}
\node[on,text width=0.1cm](EC0){};
\node[on,text width=0.1cm,right of = EC0,xshift = -0.5cm](EC1){};
