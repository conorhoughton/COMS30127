...
\pagestyle{headings}
\markright{Computational Neuroscience - Lecture 19}
\begin{document}
...
\node[align=center,text width=0.5cm,circle,draw=red, thick, fill=red!5, right = 1cm of x1](x2){$2$};
...
\path (x1) edge[thick,-o] (w1.north);
\path (x1) edge[thick,-o] (w2.north);
\path (x1) edge[thick,-o] (w3.north);
\path (x1) edge[thick,-o] (w4.north);
\path (x2) edge[dotted,-o] (w1.north);
\path (x2) edge[dotted,-o] (w2.north);
\path (x2) edge[dotted,-o] (w3.north);
\path (x2) edge[dotted,-o] (w4.north);
...
\path (w1) edge[thick,-<] (bw1);
\path (w2) edge[thick,-<] (bw2);
\path (w3) edge[thick,-<] (bw3);
\path (w4) edge[thick,-<] (bw4);
