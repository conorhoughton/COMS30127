...
\node[neuron,text width=1cm, text height=0.35cm,below  = 3.5cm of PC](DCN){DCN};
\node[scale=0.2,fill=black,right= 1.5cm of DCN](DCNr){};
\node[neuron,text height=0.35cm,right = 2cm of DCNr](ma){motor areas};
\node[neuron,text height=0.35cm,left = 2cm of GCb](ew){elsewhere};
