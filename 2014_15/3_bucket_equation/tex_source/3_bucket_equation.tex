...
\end{equation}
then we multiply across by $\exp{t/tau}$ and divide by $\tau$
\begin{equation}
\tau e^{t/\tau}\frac{dh}{dt}+\frac{1}{\tau}e^{t/\tau}h=\frac{\tilde{\i}e^{t/tau}}{\tau}
\end{equation}
...
to give
\begin{equation}
\tau\frac{d}{dt}\left(e^{t/\tau}h\right)=\frac{\tilde{\i}e^{t/tau}}{\tau}
\end{equation}
