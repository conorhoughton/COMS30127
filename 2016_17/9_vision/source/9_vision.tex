...
\pagestyle{headings}
\markright{Computation Neuroscience - 9 vision}
...
and Wiesel \cite{HubelWiesel1962a}. They used an electrode to record
from V1 neurons in anaesthetised cat; they moved an edge-like stimulus
...
feature extraction. To motivate this we will consider a fictitious
...
feature=code neurons each have a receptive field and respond linearly and
