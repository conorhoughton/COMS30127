...
$\eta (1-\alpha)^2$. Hence, it takes $1/\alpha$ patterns where a connection is
weakened to wipe out the strengthening that results if the connection is
